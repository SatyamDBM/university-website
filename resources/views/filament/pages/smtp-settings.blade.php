    ...
    <div class="mx-auto w-full">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="flex h-11 w-11 items-center justify-center rounded bg-violet-600 shadow-lg shadow-violet-500/30">
            ...
            <form wire:submit="save">
                ...
                <div class="border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                    <div class="mb-4 flex items-center gap-3">
                        <span class="text-xs font-semibold uppercase tracking-widest text-violet-600 dark:text-violet-400">Server Settings</span>
                ...
                <div class="border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                    <div class="mb-4 flex items-center gap-3">
                        <span class="text-xs font-semibold uppercase tracking-widest text-violet-600 dark:text-violet-400">Authentication</span>
                        <div class="h-px flex-1 bg-gray-100 dark:bg-gray-800"></div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                ...
                <div class="px-6 py-5">
                    <div class="mb-4 flex items-center gap-3">
                        <span class="text-xs font-semibold uppercase tracking-widest text-violet-600 dark:text-violet-400">Sender Details</span>
                        <div class="h-px flex-1 bg-gray-100 dark:bg-gray-800"></div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-6 py-4 dark:border-gray-800 dark:bg-gray-800/50">
                    ...
                    <div class="flex items-center gap-2">
                        <button type="submit"
                            class="inline-flex items-center gap-1.5 rounded bg-violet-600 px-4 py-2 text-xs font-semibold text-white shadow-md shadow-violet-500/25 transition hover:-translate-y-px hover:bg-violet-700 hover:shadow-violet-500/35 active:translate-y-0">
