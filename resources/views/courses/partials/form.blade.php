...
<div class="mb-4 grid grid-cols-2 gap-4">
    <div>
        ...
        <input type="number" name="tuition_fees" class="form-input w-full" required min="0" value="{{ old('tuition_fees', $course->tuition_fees ?? '') }}">
    </div>
    <div>
        <label class="block font-semibold mb-1">Hostel Fees</label>
        <input type="number" name="hostel_fees" class="form-input w-full" min="0" value="{{ old('hostel_fees', $course->hostel_fees ?? '') }}">
    </div>
</div>
<div class="mb-4 grid grid-cols-2 gap-4">
    <div>
        <label class="block font-semibold mb-1">Admission Fees <span class="text-red-500">*</span></label>
        <input type="number" name="admission_fees" class="form-input w-full" required min="0" value="{{ old('admission_fees', $course->admission_fees ?? '') }}">
    </div>
    <div>
        <label class="block font-semibold mb-1">Total Fees <span class="text-red-500">*</span></label>
        <input type="number" name="total_fees" class="form-input w-full" required min="0" value="{{ old('total_fees', $course->total_fees ?? '') }}">
    </div>
</div>
<div class="mb-4">
