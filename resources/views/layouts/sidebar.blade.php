...
>
    ...
    <div class="flex flex-col items-center justify-center py-6 border-b border-white/10 flex-shrink-0">
        <img src="{{ asset('storage/logo/logo.jpeg') }}"
             ...
             alt="Logo">
        <span class="text-white/60 text-xs tracking-widest uppercase font-medium">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-4 space-y-0.5
        ...
        {{-- Admissions --}}
        <div class="pt-4 pb-1 px-3">
            <span class="text-white/35 text-xs uppercase tracking-widest font-semibold">Admissions</span>
        </div>
        ...
        <a href="#"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all
            ...
            <span>All Leads</span>
            <span class="ml-auto bg-white/20 text-white text-xs px-2 py-0.5 rounded-full">32</span>
        </a>
        ...
        {{-- Marketing --}}
        <div class="pt-4 pb-1 px-3">
            <span class="text-white/35 text-xs uppercase tracking-widest font-semibold">Marketing</span>
        </div>
        ...
        <a href="#"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all
            ...
            <span>Banners</span>
            <span class="ml-auto bg-amber-400/80 text-white text-xs px-2 py-0.5 rounded-full">2</span>
        </a>
        ...
        {{-- Billing --}}
        <div class="pt-4 pb-1 px-3">
            <span class="text-white/35 text-xs uppercase tracking-widest font-semibold">Billing</span>
        </div>
        ...
        {{-- Account --}}
        <div class="pt-4 pb-1 px-3">
            <span class="text-white/35 text-xs uppercase tracking-widest font-semibold">Account</span>
        </div>
    ...
    <div class="flex-shrink-0 border-t border-white/10 p-4">
        ...
        {{-- Version label like screenshot --}}
        <div class="text-center">
            <span class="text-white/40 text-xs tracking-widest uppercase">
                {{ config('app.name', 'UniPortal') }}
            </span>
            <span class="text-white/70 text-xs font-bold ml-1">V1.0</span>
        </div>
    </div>
