...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add Finance & Admission Data</h1>
            <p class="text-sm text-gray-500 mt-1">Admission process, scholarships and loan partners</p>
        </div>
    ...
    <form method="POST" action="{{ route('university.finance.store') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            @include('university.university_data.form')
