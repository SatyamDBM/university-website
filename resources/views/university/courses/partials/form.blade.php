...
<div class="mb-4 grid grid-cols-3 gap-4">
    <div>
        ...
        <input type="number" name="tuition_fees" id="tuition_fees" class="form-input w-full border border-gray-300 " required min="0"
               value="{{ old('tuition_fees', $course->tuition_fees ?? '') }}">
    </div>
    <div>
        <label class="block font-semibold mb-1">Hostel Fees</label>
        <input type="number" name="hostel_fees" id="hostel_fees" class="form-input w-full border border-gray-300 " min="0"
    ...
    <div>
        ...
        <input type="number" name="admission_fees" id="admission_fees" class="form-input w-full border border-gray-300 " required min="0"
...
<div class="mb-4 grid grid-cols-3 gap-4">
    <div>
        ...
        <input type="number" name="total_fees" id="total_fees" class="form-input w-full border border-gray-300 " required min="0"
               value="{{ old('total_fees', $course->total_fees ?? '') }}" readonly>
    </div>
    <div>
        <label class="block font-semibold mb-1">Seat Availability</label>
        <input type="number" name="seat_availability" class="form-input w-full border border-gray-300 " min="0"
